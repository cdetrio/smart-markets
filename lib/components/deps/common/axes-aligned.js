...
exports.XAxis = React.createClass({displayName: "XAxis",
  ...
  _renderAxis: function(props) {
    ...
    d3.select(node)
      ...
      .attr("transform", function(d) {
        console.log('applying transform to x axis. props.xZeroAligned:', props.xZeroAligned);
        var transformStr = "translate(0," + props.yScale(0) + ")";
        //return props.xZeroAligned ? transformStr : null;
        return null;
      })
      */
      .call(xAxis);
  ...
  render: function() {
    ...
    //console.log('props.yScale(20):', props.yScale(20));
    //console.log('props.xScale(20):', props.xScale(20));
    //var t = "translate(0," + (props.height - props.yScale(0)) + ")";
